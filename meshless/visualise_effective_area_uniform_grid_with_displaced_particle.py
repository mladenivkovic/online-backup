...
def main():
    ...
    fig.suptitle(
        r"Effective Area $\mathbf{A}_{ij}$ of a particle w.r.t. the central partilce in a uniform distribution"
    )
    plt.tight_layout()
    plt.savefig("effective_area_displaced_particle.png", dpi=300)
