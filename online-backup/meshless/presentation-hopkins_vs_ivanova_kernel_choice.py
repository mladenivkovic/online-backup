...
setplotparams_multiple_plots(wspace=0.0, hspace=0.0, for_presentation=True)
    ...
    for plot in range(2):
        ...
        for row in range(nrows):
            ...
            for col, ax in enumerate(axcols):
                ...
                im = ax.imshow(imgdata[row][col+counter], origin='lower', 
                    cmap=cmap,
                ...
                if row == 0:
                    name = ms.kernel_pretty_names[col+counter]
        ...
        plt.savefig('testing-different_kernels-'+plotnames[plot]+'.png', dpi=300)
