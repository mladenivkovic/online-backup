...
#======================================
def find_neighbours(xx, yy, hh, hlim):
#======================================
    """
    Find indices of all neighbours within hlim*h (where kernel != 0)
        ...
        for row, hf in enumerate(hfact):
            ...
            for i in range(nx):
                ...
                for j in range(nx):
                    ...
                    nbors = find_neighbours(xx, yy, hh, hf)
