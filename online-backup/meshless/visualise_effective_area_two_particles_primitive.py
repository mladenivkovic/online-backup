    ...
    for i in range(nx):
        ...
        for j in range(nx):
            ...
            for k in range(nx):
                ...
                sp = ax1.scatter3D(x, y, z, c=[A[i,j,k]], cmap='YlGnBu_r', vmin=cmin, vmax=cmax)
...
#=========================================
    ...
    for A,direction in [(Ax, 'x'), (Ay, 'y'), (Az, 'z')]:
        ...
        for s in range(nslices):
            ...
            i3 = ax3.imshow(A[:, :, ind], cmap='YlGnBu_r', origin='lower',
                extent=(0, boxlen, 0, boxlen), vmin=cmin, vmax=cmax)
            ax3.set_xlabel('x')
            ax3.set_ylabel('y')
...
#=========================================
    ...
    for A,direction in [(Ax, 'x'), (Ay, 'y'), (Az, 'z'), (Aabs, 'norm')]:
        ...
        i3 = ax3.imshow(np.sum(A,2), cmap='YlGnBu_r', origin='lower',
            extent=(0, boxlen, 0, boxlen))
        ax3.set_xlabel('x')
        ax3.set_ylabel('y')
